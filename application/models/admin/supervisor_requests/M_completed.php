...
class M_completed extends CI_Model
{
  ...
  function make_query()
  {
    ...
    $select_column = array("srequest_id","request_id","rpr_id","supervisor_id","supervisor_name","agency_id","agency_name","product_id","supervisor_request_products.broken_count","supervisor_request_products.smell_defect_count","supervisor_request_products.new_cans_allowed","quantity","status","date","time");
