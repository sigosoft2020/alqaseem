    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="card-body">
           <form role="form" method="post" action="<?=site_url('warehouse/history/orderHistory')?>"> 
            <div class="row">
              <div class="col-md-3">
                  ...
                  <?php  foreach($stocks as $stock)
                    {?>
                     <tr>   
                      ...
                      <td><a href="<?=site_url('warehouse/warehouse/stockHistoryInvoice/'.$stock->rpr_id)?>" class="btn btn-primary" style="font-size: 10px;" >Print</a></td>
                     </tr> 
                  <?php  }?>                
                </tbody>
              </table>
