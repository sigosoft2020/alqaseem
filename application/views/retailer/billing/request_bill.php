        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="Myform" action="<?=site_url('retailer/bill/addRequestData')?>" method="POST">
                <div class="card-body">
                 <div class="row">
                   <div class="col-md-8"> 
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="customer_name" value="<?=$request->name_english?>" readonly>
                        <input type="hidden" name="customer_id" value="<?=$request->customer_id?>">
                        <input type="hidden" name="request_id" value="<?=$request->rsrequest_id?>">
                      </div>
