          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Retail Manager</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="Myform" action="<?=site_url('admin/users/addRetailManager')?>" method="POST">
                <div class="card-body">
                  <div class="row">
                    <!-- <div class="col-md-6">  -->
  ...
  <script type="">
    $('#Myform').on('submit', function(e){
      ...
      // alert(mobile);
       $.ajax({
        method: "POST",
        url: "<?php echo site_url('admin/users/checkRetailManager');?>",
        dataType : "json",
        data : { phone      : phone,
                 email       : email
               },
