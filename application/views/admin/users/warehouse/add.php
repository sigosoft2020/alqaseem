          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Warehouse Manager</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="Myform" action="<?=site_url('admin/users/addWarehouseManager')?>" method="POST">
                <div class="card-body">
                  <div class="row">
                    <!-- <div class="col-md-6">  -->
                    ...
                    <div class="col-12 col-sm-6">      
                      <div class="form-group">
                        ...
                        <input type="text" name="phone" id="phone" class="form-control" placeholder=" Phone" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="11" required>
                      </div>
                    </div>
                    <div class="col-12 col-sm-6">      
                      <div class="form-group">
  ...
  <script type="">
    $('#Myform').on('submit', function(e){
      ...
      // alert(mobile);
       $.ajax({
        method: "POST",
        url: "<?php echo site_url('admin/users/checkWarehouseManager');?>",
        dataType : "json",
        data : { phone      : phone,
                 email       : email
               },
