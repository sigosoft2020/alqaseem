        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-right">
              <a href="<?=site_url('admin/users/add_supervisor')?>"><button type="button" class="btn btn-primary btn-rounded waves-light waves-effect w-md">Add Supervisor</button></a>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <form class="form-horizontal" action="<?=site_url('admin/users/changePassword_supervisor')?>" method="post" onsubmit="return check()">
...
<script type="text/javascript">
    $(document).ready(function(){
      var dataTable = $('#user_data').DataTable({
        ...
        "order":[],
        "ajax":{
          url:"<?=site_url('admin/users/get_supervisor')?>",
          type:"POST"
        },
        "columnDefs":[
          {
