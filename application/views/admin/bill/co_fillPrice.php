          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="datatable" class="table table-bordered table-striped" style="width: 100%;">
                ...
                <tbody>                
                   <tr>   
                    <td><?php echo $cofill->unit; ?></td>
                    <td><?php echo $cofill->price; ?></td>
                    <td><button class="btn btn-primary" type="button" onclick="edit('<?=$cofill->price_id?>')" >Edit</button></td>
                   </tr>                
                </tbody>
              </table>
            </div>
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <form class="form-horizontal" action="<?=site_url('admin/bill/priceUpdate/co')?>" method="post">
