                    ...
                    <table class="row">
                        <tr>
                            ...
                            <td class="col-md-6 text-right">
                                <h4>Invoice No : #INVAS<?php echo $order->as_id;?></h4>
                                <h4>Date: <?php echo date('d-M-Y',strtotime($order->sale_date));?></h4>
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td colspan="7">
                    <table>
                        <tr>                       
                             ...
                             <td>
                                 <?php echo $order->agency_name;?><br>
                                 <?php echo $order->agency_phone;?><br>
                            </td> 
                        </tr>
                    </table>
                </td>
