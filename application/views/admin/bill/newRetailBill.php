        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="Myform" action="<?=site_url('admin/bill/addData')?>" method="POST">
                <div class="card-body">
                 <div class="row">
                   <div class="col-md-8"> 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal" id="Myform" action="<?=site_url('admin/bill/addCustomer')?>" method="post" enctype="multipart/form-data">
                        <div class="form-group m-b-25">
                            <div class="col-12">
