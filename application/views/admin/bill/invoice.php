                    ...
                    <table class="row">
                        <tr>
                            ...
                            <td class="col-md-6 text-right">
                                <h4>Invoice No : #INVOR<?php echo $order->order_id;?></h4>
                                <h4>Date: <?php echo date('d-M-Y',strtotime($order->billing_date));?></h4>
                            </td>
                        </tr>
                    </table>
                </td>
               ...
               <tbody>
                ...
                <tfoot>               
                    <tr>  
                      ...
                      <td><b>AED <?php echo $order->total;?></b><br>
                          <b>AED <?=$order->amount_received?></b><br>
                          <?php if($order->credit_balance!='0') {?>
                            <b>AED <?=$order->credit_balance?></b>
                          <?php };?>  
                      </td>
                    </tr>
                </tfoot> 
