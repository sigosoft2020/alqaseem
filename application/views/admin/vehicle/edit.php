        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?=site_url('admin/vehicle/editData')?>" method="POST">
                <div class="card-body">
                  <div class="row">
                  <!-- <div class="col-md-6">  -->
                  <div class="col-12 col-sm-6">    
                    <div class="form-group">
                       <label for="select">Vehicle Number<span style="color: red;">*</span></label>
                        <input type="text" name="vehicle_number" id="vehicle_number" class="form-control" value="<?=$vehicle->vehicle_no?>" placeholder="Vehicle Number" maxlength="100" required>
                  ...
                  <div class="col-12 col-sm-6">    
                    <div class="form-group">
                        ...
                        <input type="text" name="person_name" id="person_name" class="form-control" value="<?=$vehicle->person_name?>" placeholder="Person Name English" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))' required>
                    </div>
                  </div>
                  <div class="col-12 col-sm-6">    
                      <div class="form-group">
                        <label for="select">Person Name Arabic</label>
                        <input type="text" name="person_arabic" id="person_arabic" class="form-control" placeholder="Person Name Arabic" value="<?=$vehicle->name_arabic?>" onkeypress='return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || (event.charCode == 32))'>
                      </div>
                  </div>   
                  <div class="col-12 col-sm-6">    
                    <div class="form-group">
                      <label for="select">Person Phone<span style="color: red;">*</span></label>
                      <input type="text" name="person_phone" id="person_phone" class="form-control" value="<?=$vehicle->person_phone?>" placeholder="Person Phone" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="11" required>
                    </div>
                  </div>
                  <div class="col-12 col-sm-6">   
                    <div class="form-group">
                      <label for="select">Person Address<span style="color: red;">*</span></label>
                     <textarea type="text" name="person_address" id="person_address" class="form-control" placeholder="Person Address" required><?=$vehicle->person_address?></textarea>
                   </div>
                  </div> 
                  <div class="col-12 col-sm-6">  
                    <div class="form-group">
                  ...
                  <div class="col-12 col-sm-6">    
                     <div id="current-image">
                        <img src="<?=base_url() . $vehicle->person_image?>" height="300px" width="300px">
                      </div>    
